...
function ModelBox({ config, weights, slices, forward_steps, prediction, backward,
  ...
  return (
    <div className="rounded-xl border-2 overflow-hidden"
      style={{ borderColor: '#ffb74d', background: 'linear-gradient(135deg, #0f1117, #1a1508)' }}>
      <div className="flex items-center justify-between px-4 py-2.5"
        style={{ background:'#2a1a0a', borderBottom:'1px solid #ffb74d40' }}>
        <div className="flex items-center gap-2">
          <Cpu size={15} style={{ color:'#ffb74d' }} />
      ...
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full" style={{ maxHeight: 700 }}>
        ...
        <g>
          <text x={queueX + 60} y={20} textAnchor="middle" fontSize={11}
            fill="#ce93d8" fontFamily="monospace" fontWeight="bold">
            📦 ENTRÉE
          </text>
          ...
          <line x1={queueX + 130} y1={60} x2={queueX + 130} y2={50 + seq_length * 75}
            stroke="#ce93d8" strokeWidth={1} strokeDasharray="3,2" markerEnd="url(#arrow)" opacity={0.5}/>
          <text x={queueX + 138} y={50 + seq_length * 38} fontSize={9}
            fill="#ce93d8" fontFamily="monospace">temps</text>
        ...
        {/* ═══════════════════════════════════════════════════════ */}
        <text x={sumX} y={20} textAnchor="middle" fontSize={11} fill="#ffb74d"
          fontFamily="monospace" fontWeight="bold">SOMMATION</text>
        <text x={sumX} y={34} textAnchor="middle" fontSize={9} fill="#4a4d6a"
        ...
        {inputYs.map((y, i) => (
          <line key={`xw-${i}`}
            x1={inputX + 22} y1={y}
            x2={sumX - 18} y2={cy}
            stroke={showForwardFlow && activeLayer === 0 ? '#4fc3f7' : '#2a2d45'}
        ...
        <g transform={`translate(${(inputX + sumX) / 2}, ${cy - 60})`}>
          <rect x={-30} y={-12} width={60} height={20} rx={4}
            fill="#0f1117" stroke="#4fc3f7" strokeWidth={1}/>
          <text x={0} y={2} textAnchor="middle" fontSize={11}
            fill="#4fc3f7" fontFamily="monospace" fontWeight="bold">W_xh</text>
        </g>
        ...
        {showForwardFlow && (
          <>
            <path d={`M ${sumX} ${cy + 80} Q ${sumX} ${cy + 30}, ${sumX - 12} ${cy + 8}`}
              fill="none" stroke="#ce93d8" strokeWidth={1.2}
              strokeDasharray="3,2" markerEnd="url(#arrow)" opacity={0.7}/>
            <text x={sumX + 8} y={cy + 50} fontSize={10}
              fill="#ce93d8" fontFamily="monospace">H_{activeT}·W_hh</text>
          </>
        )}
        ...
        {showForwardFlow && (
          <>
            <line x1={sumX - 60} y1={cy - 80}
              x2={sumX - 14} y2={cy - 14}
              stroke="#ffb74d" strokeWidth={1.2}
              markerEnd="url(#arrow)" opacity={0.7}/>
            <text x={sumX - 65} y={cy - 85} fontSize={10}
              fill="#ffb74d" fontFamily="monospace">+ b</text>
          </>
        )}
        ...
        {/* ═══════════════════════════════════════════════════════ */}
        <text x={tanhX} y={20} textAnchor="middle" fontSize={11} fill="#4caf50"
          fontFamily="monospace" fontWeight="bold">ACTIVATION</text>
        <text x={tanhX} y={34} textAnchor="middle" fontSize={9} fill="#4a4d6a"
          fontFamily="monospace">tanh écrase [-1, 1]</text>

        {/* Flèche Z → tanh */}
        <line x1={sumX + 22} y1={cy} x2={tanhX - 28} y2={cy}
          stroke={showForwardFlow ? '#ffb74d' : '#2a2d45'}
        ...
        {layerXs.map((x, L) => (
          <g key={`L-title-${L}`}>
            ...
            <text x={x} y={34} textAnchor="middle" fontSize={9} fill="#4a4d6a"
        ...
        <line x1={tanhX + 28} y1={cy} x2={layerXs[0] - 18} y2={cy}
          stroke={showForwardFlow ? LAYER_COLORS[0] : '#2a2d45'}
          strokeWidth={showForwardFlow ? 1.5 : 0.5}
          markerEnd="url(#arrow)" opacity={0.8}/>
        {showForwardFlow && (
          <motion.circle r={4} fill="#4caf50"
        ...
        {layerXs.slice(0, -1).map((x1, L) => (
          <g key={`layerconn-${L}`}>
            ...
            <g transform={`translate(${(x1 + layerXs[L + 1]) / 2}, ${cy - 100})`}>
              <rect x={-30} y={-12} width={60} height={20} rx={4}
                fill="#0f1117" stroke={LAYER_COLORS[L + 1]} strokeWidth={1}/>
              <text x={0} y={2} textAnchor="middle" fontSize={11}
          ...
          ys.map((y, j) => (
            ...
            >
              <circle cx={layerXs[L]} cy={y} r={14}
                fill={activeLayer === L && showForwardFlow ? `${LAYER_COLORS[L]}50` : '#1a1d2e'}
        ...
        {layerXs.map((x, L) => (
          <g key={`rec-${L}`}>
            <path
              ...
              fill="none"
              stroke={activeLayer === L && showForwardFlow ? LAYER_COLORS[L] : '#3d4172'}
            ...
            <text x={x + 70} y={cy + 18} fontSize={9} fill="#4a4d6a"
          ...
          <>
            ...
            <g transform={`translate(${(lastLayerX + outputX) / 2}, ${cy + 100})`}>
              <rect x={-40} y={-12} width={80} height={20} rx={4}
                fill="#2a0d0d" stroke="#f06292" strokeWidth={1}/>
        ...
        <line x1={50} y1={zoomY - 30} x2={W - 50} y2={zoomY - 30}
          stroke="#2a2d45" strokeWidth={1} strokeDasharray="4,4"/>
        ...
        <g transform={`translate(${W / 2 - 280}, ${zoomY + 5})`}>
          ...
          <rect x={0} y={0} width={70} height={50} rx={5}
            fill="#3a2a0d" stroke="#ffb74d" strokeWidth={2}/>
          <text x={35} y={20} textAnchor="middle" fontSize={11}
            fill="#ffb74d" fontFamily="monospace" fontWeight="bold">
            Z entrée
          </text>
          ...
          <line x1={75} y1={25} x2={120} y2={25}
            stroke="#ffb74d" strokeWidth={2} markerEnd="url(#arrow)"/>

          {/* Boîte tanh */}
          <rect x={125} y={-5} width={130} height={60} rx={5}
            fill="#0d2a1a" stroke="#4caf50" strokeWidth={2}/>
          <text x={190} y={10} textAnchor="middle" fontSize={10}
            fill="#4caf50" fontFamily="monospace" fontWeight="bold">
            tanh
          </text>
          ...
          <line x1={190} y1={0} x2={190} y2={50}
            stroke="#4caf50" strokeWidth={0.3} opacity={0.4}/>
          <text x={245} y={48} fontSize={8} fill="#4a4d6a">+1</text>
          <text x={245} y={8} fontSize={8} fill="#4a4d6a">-1</text>

          {/* Flèche */}
          <line x1={260} y1={25} x2={305} y2={25}
            stroke="#4caf50" strokeWidth={2} markerEnd="url(#arrow)"/>
          ...
          <text x={400} y={15} fontSize={11}
            fill="#c8cad4" fontFamily="monospace" fontWeight="bold">
            🧠 La fonction tanh "écrase"
          </text>
          <text x={400} y={32} fontSize={10}
            fill="#8a8d9f" fontFamily="monospace">
        ...
        <line x1={0} y1={H - 36} x2={W} y2={H - 36}
          stroke={mode === 'forward' ? '#4fc3f7' : mode === 'predict' ? '#f06292' : mode === 'backprop' ? '#f06292' : '#3d4172'}
          strokeWidth={2}/>
...
function ArchSelector({ value, onChange }) {
  const archs = [
    { id: 'rnn',         label: 'RNN',         color: '#4fc3f7', desc: 'Réseau récurrent simple', enabled: true },
    { id: 'lstm',        label: 'LSTM',        color: '#ce93d8', desc: '4 portes + cellule', enabled: true },
    { id: 'gru',         label: 'GRU',         color: '#ffb74d', desc: '2 portes simplifiées', enabled: false },
    { id: 'transformer', label: 'Transformer', color: '#81c784', desc: 'Self-attention', enabled: false },
  ];
      ...
      <div className="grid grid-cols-2 gap-1.5">
        {archs.map(a => (
          <button key={a.id}
            ...
            style={{
              background: value === a.id ? `${a.color}20` : '#232640',
              borderColor: value === a.id ? a.color : '#2a2d45',
              color: value === a.id ? a.color : a.enabled ? '#8a8d9f' : '#4a4d6a',
            ...
            <div className="text-[9px] mt-0.5" style={{ color:'#4a4d6a' }}>
...
function InputFlow({ tensor3D, slices, featNames, batchSize, seqLength, activeT = -1 }) {
  ...
  return (
    <div className="rounded-xl border p-4 space-y-4"
      style={{ background: '#0f1117', borderColor: '#ce93d840' }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Box size={14} style={{ color: '#ce93d8' }} />
      ...
      <div className="flex items-start gap-3 overflow-x-auto pb-2">
        ...
        <div className="flex-shrink-0">
          <p className="text-xs text-center mb-1 font-bold" style={{ color: '#ce93d8' }}>
            🧊 Tenseur X (3D réel)
          </p>
          <svg width={svgW} height={svgH}>
              ...
              Array.from({ length: featNames.length }).map((_, k) => {
                ...
                return (
                  <polygon key={`front-${j}-${k}`}
                    points={`${p1.x},${p1.y} ${p2.x},${p2.y} ${p3.x},${p3.y} ${p4.x},${p4.y}`}
                    fill={cellColor(v)}
                    stroke={isActiveT ? '#4fc3f7' : '#ce93d8'}
            ...
            <g>
              ...
              <text x={ox + width / 2} y={oy + heightT + 28}
                ...
                fill="#4fc3f7" fontFamily="monospace" fontWeight="bold">
            ...
            <g>
              <line
                ...
                stroke="#81c784" strokeWidth={1.5}
                markerEnd="url(#iso-arrow)"
              />
              <text x={ox - 24} y={oy + heightT / 2}
                textAnchor="middle" fontSize={10}
                fill="#81c784" fontFamily="monospace" fontWeight="bold"
        ...
        >
          <p className="text-xs mb-2 text-center font-bold" style={{ color: '#ce93d8' }}>
            Découpage<br/>temporel
          </p>
          <ArrowRight size={32} style={{ color: '#ce93d8' }}/>
          <p className="text-xs mt-2 text-center" style={{ color: '#8a8d9f' }}>
            On extrait<br/>{seqLength} tranches<br/>2D
          </p>
          <p className="text-[10px] mt-2 font-mono text-center" style={{ color: '#4a4d6a' }}>
        ...
        {/* ═══════════ TRANCHES 2D ═══════════ */}
        <div>
          <p className="text-xs text-center mb-1 font-bold" style={{ color: '#81c784' }}>
              ...
              return (
                ...
                >
                  <span className="text-xs font-mono mb-1 font-bold"
                    style={{ color: isActive ? '#4fc3f7' : isPast ? '#4a4d6a' : '#81c784' }}>
                    X<sub>{t + 1}</sub>
                    {isActive && ' ⬅️'}
                  </span>
                  <Matrix
                    ...
                    rowLabels={seqLabels}
                    colLabels={featNames}
                    color={isActive ? '#4fc3f7' : isPast ? '#4a4d6a' : '#81c784'}
                    decimals={3}
                    small
                    highlight={isActive}
                  />
                  <span className="text-[9px] mt-1" style={{ color: '#4a4d6a' }}>
      ...
      <p className="text-xs italic px-3 py-2 rounded" style={{
        background: '#1a1d2e', color: '#8a8d9f', borderLeft: '2px solid #ce93d8'
      }}>
        💡 <b>Comment lire le cube ?</b><br/>
        • <span style={{color:'#4fc3f7'}}>Axe horizontal (Features)</span> : les {featNames.length} capteurs (volt, rotate, pressure, vibration)<br/>
        • <span style={{color:'#81c784'}}>Axe vertical (Time)</span> : les {seqLength} heures consécutives<br/>
        • <span style={{color:'#ffb74d'}}>Axe profondeur (Batch)</span> : les {batchSize} séquences traitées en parallèle<br/>
...
function MatMulVisual({
  ...
  colorA = '#4fc3f7', colorB = '#ffb74d', colorC = '#4caf50',
  ...
  const renderCell = (v, eff, isHighlighted, isResult, color) => (
    <div className="flex items-center justify-center text-xs font-mono border"
      style={{
        ...
        borderColor: isHighlighted ? color : '#1e2135',
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2 flex-wrap justify-center">
        ...
        <div className="flex flex-col items-center">
          <span className="text-sm font-bold mb-1" style={{ color: colorA }}>
            {labelA} <span className="text-xs" style={{ color: '#4a4d6a' }}>
              ...
              {rowLabelsA && (
                <div className="flex flex-col mr-1 justify-center">
                  {rowLabelsA.map((lab, i) => (
                    <div key={i} className="flex items-center justify-end pr-2 text-xs font-mono"
                      style={{ height: cellH, color: i === hoverRow ? colorA : '#8a8d9f',
        ...
        <div className="text-3xl font-bold mx-1" style={{ color: '#8a8d9f' }}>·</div>

        {/* Matrice B */}
        <div className="flex flex-col items-center">
          <span className="text-sm font-bold mb-1" style={{ color: colorB }}>
            {labelB} <span className="text-xs" style={{ color: '#4a4d6a' }}>
              ...
              {rowLabelsB && (
                <div className="flex flex-col mr-1 justify-center">
                  {rowLabelsB.map((lab, i) => (
                    <div key={i} className="flex items-center justify-end pr-2 text-xs font-mono"
                      style={{ height: cellH, color: '#8a8d9f', minWidth: 42 }}>
                      {lab}
                    </div>
                  ))}
                </div>
                  ...
                  <div className="flex">
                    {colLabelsB.map((lab, j) => (
                      <div key={j} className="text-center text-xs font-mono pb-1"
                        style={{
                          width: cellW,
                          color: j === hoverCol ? colorB : '#4a4d6a',
        ...
        {/* Symbole = */}
        <div className="text-2xl font-bold mx-1" style={{ color: '#8a8d9f' }}>=</div>

        {/* Matrice résultat */}
        <div className="flex flex-col items-center">
          <span className="text-sm font-bold mb-1" style={{ color: colorC }}>
            {labelC} <span className="text-xs" style={{ color: '#4a4d6a' }}>
      ...
      <motion.div
        ...
        style={{ background: '#1a1d2e', border: '1px solid #4caf5040' }}
      >
        ...
        <div className="font-mono text-xs leading-relaxed" style={{ color: '#c8cad4' }}>
          <div className="mb-1" style={{ color: '#8a8d9f' }}>
          ...
          <div className="mb-1">
            = {aRow.map((a, i) => (
              <span key={i}>
                ...
                {i < aRow.length - 1 && <span style={{ color: '#4a4d6a' }}> + </span>}
              </span>
            ))}
          </div>
          <div className="mb-1" style={{ color: '#8a8d9f' }}>
            = {products.map((p, i) => (
              <span key={i}>
                <span style={{ color: p >= 0 ? '#4fc3f7' : '#f06292' }}>
          ...
          <div className="font-bold pt-1 border-t" style={{ borderColor: '#2a2d45', color: colorC }}>
  ...
  return (
    <div className="space-y-3">
      <div className="rounded-xl p-4 border-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
          {steps.map((step, i) => (
            <motion.div key={step.num}
              ...
              <p className="text-xs font-semibold mb-1.5" style={{ color: '#e4e6f0' }}>
                {step.desc}
              </p>

              <div className="rounded p-1.5 mb-2 text-center"
                style={{ background: '#1a1d2e', minHeight: 38 }}>
                <span style={{ fontSize: '0.8em' }}>
                  <InlineMath math={step.formula}/>
                </span>
              </div>

              <p className="text-[10px] leading-snug" style={{ color: '#8a8d9f' }}>
                {step.explanation}
              </p>
        ...
        <div className="mt-3 pt-3 border-t" style={{ borderColor: '#2a2d45' }}>
          <p className="text-xs font-semibold mb-2" style={{ color: '#ce93d8' }}>
            📐 En une seule formule mathématique :
          </p>
          <div className="rounded-lg p-2 text-center" style={{ background: '#1a1d2e' }}>
          ...
          >
            ...
            {scene.matmul && (
              <div className="my-4 rounded-lg p-4 overflow-x-auto"
                style={{ background: '#0a0c14', border: '1px solid #4caf5040' }}>
            ...
            {scene.formulaWithValues && (
              <div className="rounded-lg p-3 my-3"
                style={{ background:'#0d1a2a', border:'1px solid #4fc3f740' }}>
                <p className="text-xs mb-1" style={{ color:'#4a4d6a' }}>Application numérique :</p>
...
function buildScenario(data) {
  ...
  scenes.push({
    ...
    note: `Tous les nombres affichés sont les VRAIES valeurs de la Machine 99.`,
  });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold" style={{ color:'#e4e6f0' }}>
              Démo Architecture — Vraies données Machine 99
            </h2>
        ...
        {data && (
          <div className="flex items-center gap-2 text-xs font-mono">
            ...
            <span className="px-2 py-1 rounded uppercase"
              style={{ background:'#1a1d2e', color:'#4fc3f7' }}>
              {arch}
            </span>
          </div>
        )}
              ...
              <div className="rounded-xl border p-3" style={{ background:'#1a1d2e', borderColor:'#2a2d45' }}>
                <div className="flex items-center gap-2 flex-wrap mb-2">
                  ...
                  <button onClick={() => setSceneIndex(s => Math.min(scenes.length - 1, s + 1))}
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-semibold"
                    style={{ background:'#232640', border:'1px solid #4fc3f740', color:'#4fc3f7' }}>
                    Suivant →
                  </button>
                  ...
                  <div className="flex items-center gap-1 ml-2">
                    ...
                    {[5000, 3500, 2000, 1000].map((s, i) => (
                      <button key={s} onClick={() => setSpeed(s)}
                        ...
                        style={{
                          background: speed === s ? '#1a3a5c' : '#232640',
                          borderColor: speed === s ? '#4fc3f7' : '#2a2d45',
                          color: speed === s ? '#4fc3f7' : '#4a4d6a',
                        }}>
                        {['🐢','🚶','🏃','⚡'][i]}
                      </button>
                    ))}
                ...
                <div className="w-full h-1 rounded overflow-hidden" style={{ background:'#0a0c14' }}>
                  <div className="h-full transition-all duration-300"
                    style={{
                      ...
                      background: 'linear-gradient(90deg,#4fc3f7,#ce93d8,#ffb74d,#f06292)',
                    }}/>
                </div>
              </div>
